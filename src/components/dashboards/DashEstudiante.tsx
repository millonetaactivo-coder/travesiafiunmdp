...
import { HelpCircle, FileText, CheckCircle, AlertTriangle, Loader2 } from 'lucide-react';
...
export const DashEstudiante = () => {
  ...
  // Radial chart data — use real score from ultimoScore
  const scoreValue = ultimoScore?.valor != null ? Math.round(Number(ultimoScore.valor)) : 0;
  const data = [{ name: 'Progress', value: scoreValue, fill: levelInfo.color }];
